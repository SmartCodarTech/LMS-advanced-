                    ...
                    while($row = $query->fetch_assoc()){
                      ...
                      echo "
                        ...
                        <a href='#edit_photo' data-toggle='modal' class='pull-right photo' data-id='".$row['bookid']."'><span class='fa fa-edit'></span></a>
                          ...
                          <td>".$status."</td>
                          <td>
                            <button class='btn btn-success btn-sm edit btn-flat' data-id='".$row['bookid']."'><i class='fa fa-edit'></i></button>
                            <button class='btn btn-danger btn-sm delete btn-flat' data-id='".$row['bookid']."'><i class='fa fa-trash'></i></button>
                          </td>
                        </tr>
                      ";
                    }
